$(document).ready(function() {
	const numBlocksArrayData1x = [  0, 28, 56, 84,112,140, 28, 56, 84,112,
						 	     28,  0, 28, 56, 84,112,140,140,140];
	const numBlocksArrayData1y = [ 28,  0,  0,  0,  0, 28, 56, 56, 56, 56,
							    112,140,140,140,140,140,140,112,168];

	const numBlocksArrayData2x = [  0, 28, 56, 84,112,140, 28, 56, 84,112,
							     28,  0, 28, 56, 84,112,140,140,140];
	const numBlocksArrayData2y = [ 28,  0,  0,  0,  0, 28, 56, 56, 56, 56,
							    112,140,168,168,140,112,112,140,168];

	const numBlocksArrayData3x = [  0, 28, 56, 84,112,140, 28, 56, 84,112,
							      0,  0,  0, 28, 56, 84,112,140,112];
	const numBlocksArrayData3y = [ 28,  0,  0,  0,  0, 28, 56, 56, 56, 56,
							    112,140,168,168,140,168,168,140,112];

	const numBlocksArrayData4x = [  0, 28, 56, 84,112,140, 28, 56, 84,112,
							     28, 56, 84, 84,  0, 28, 56, 84,112,140];
	const numBlocksArrayData4y = [ 28,  0,  0,  0,  0, 28, 56, 56, 56, 56,
							    140,112,112,140,168,168,168,168,168,168];

	const numBlocksArrayData5x = [  0, 28, 56, 84,112,140, 28, 56, 84,112,
							      0,  0,  0, 28, 56, 56, 84,112,112,140];
	const numBlocksArrayData5y = [ 28,  0,  0,  0,  0, 28, 56, 56, 56, 56,
							    112,140,168,112,112,140,168,168,112,140];

	const numBlocksArrayData6x = [  0, 28, 56, 84,112,140, 28, 56, 84,112,
							     28,  0, 28, 56, 84,112,140,112, 84];
	const numBlocksArrayData6y = [ 28,  0,  0,  0,  0, 28, 56, 56, 56, 56,
							    168,140,112,112,112,112,140,168,140];

	const numBlocksArrayData7x = [  0, 28, 56, 84,112,140, 28, 56, 84,112,
							      0,  0,  0, 28, 56, 84,112,140];
	const numBlocksArrayData7y = [ 28,  0,  0,  0,  0, 28, 56, 56, 56, 56,
							    112,140,168,168,168,140,112,112];
